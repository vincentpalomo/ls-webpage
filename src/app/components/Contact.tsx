...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-off-black text-off-white font-montserrat flex flex-col justify-center" id="contact">
      <div className="">
        <div className="sm:relative w-full sm:mt-20 mb-10 mt-20 ml-5 sm:ml-0 pointer-events-none">
          <div className="font-montserrat uppercase 2xl:text-[11.25rem] 2xl:leading-[180px] text-7xl sm:tracking-title xl:text-mac xl:leading-mac sm:ml-20 font-black">
            let&apos;s talk
          </div>
        ...
        <div className="sm:ml-20 ml-5 mt-10">
